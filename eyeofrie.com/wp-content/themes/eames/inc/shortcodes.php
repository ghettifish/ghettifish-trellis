...
add_shortcode('wp_caption', 'eames_img_caption_shortcode');
add_shortcode('caption', 'eames_img_caption_shortcode');

function eames_img_caption_shortcode($attr, $content = null) {
	...
	. do_shortcode( $content ) . '<div class="caption"><h2>' . $atts['title'] . '</h2><p>' . $atts['caption'] . '</p></div></div>';
}