...
function et_divi_customizer_theme_settings( $wp_customize ) {
	...
	$wp_customize->add_setting( 'et_divi[widget_header_font_size]', array(
		'default'       => et_get_option( intval('body_header_size') * .6, '18' ),
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
		'sanitize_callback' => 'absint',
...
function et_divi_add_customizer_css(){ ?>
	<?php
		...
		$widget_header_font_size = intval( et_get_option( 'widget_header_font_size', intval( et_get_option( intval('body_header_size') * .6, '18' ) ) ) );
